...
<head>
    ...
    <link href="assets/canvas/css/vpc_custom.css" id="app-style" rel="stylesheet" type="text/css" />
...
<body data-sidebar="dark">
                    ...
                    <div class="row" style="display: none;">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">VPC Board</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Tasks</a></li>
                                        <li class="breadcrumb-item active">VPC Board</li>
                                    </ol>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <h4 class="mb-0 font-size-18">Value Proposition</h4>
                                    <!-- <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Tasks</a></li>
                                        <li class="breadcrumb-item active">VPC Board</li>
                                    </ol> -->
                                    ...
                                    <div class="dropdown float-right">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#"
                                                onclick="event.preventDefault();openModal('1');">Add</a>

                                        </div>
                                    </div> <!-- end dropdown -->

                                    <h4 class="card-title mb-4">Customer Jobs</h4>
                                    <div id="customer-jobs" class="pb-1 task-list">
                            ...
                            <div class="card">
                                <div class="odd card-body">
                                    <div class="dropdown float-right">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#"
                                                onclick="event.preventDefault();openModal('2');">Add</a>

                                        </div>
                                    </div> <!-- end dropdown -->

                                    <h4 class="card-title mb-4">Gains</h4>
                                    <div id="gains" class="pb-1 task-list">
                                        <!-- start task card -->
                            ...
                            <div class="card">
                                <div class="odd card-body">
                                    <div class="dropdown float-right">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#"
                                                onclick="event.preventDefault();openModal('3');">Add</a>

                                        </div>
                                    </div> <!-- end dropdown -->

                                    <h4 class="card-title mb-4">Pains</h4>
                                    <div id="pains" class="pb-1 task-list">
                                        <!-- start task card -->
                            ...
                            <div class="card" style="margin-bottom: 0px;">
                                <div class="odd card-body">
                                    <div class="dropdown float-right">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#"
                                                onclick="event.preventDefault();openModal('4');">Add</a>

                                        </div>
                                    </div> <!-- end dropdown -->

                                    <h4 class="card-title mb-4">Gain Creators</h4>
                                    <div id="gain-creators" class="pb-1 task-list">
                            ...
                            <div class="card">
                                <div class="odd card-body">
                                    <div class="dropdown float-right">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#"
                                                onclick="event.preventDefault();openModal('5');">Add</a>

                                        </div>
                                    </div> <!-- end dropdown -->

                                    <h4 class="card-title mb-4">Pain Relievers</h4>
                                    <div id="pain-relievers" class="pb-1 task-list">
                                        <!-- start task card -->
                            ...
                            <div class="card">
                                <div class="even card-body">
                                    <div class="dropdown float-right">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="#"
                                                onclick="event.preventDefault();openModal('6');">Add</a>

                                        </div>
                                    </div> <!-- end dropdown -->

                                    <h4 class="card-title mb-4">Products & Services</h4>
                                    <div id="products-services" class="pb-1 task-list">
    ...
    <script src="assets/canvas/js/vpc_custom.js"></script>
    <script src="assets/canvas/js/vpc_api.js"></script>
    ...
    <script src="assets/canvas/js/vpc_canvas.init.js"></script>
