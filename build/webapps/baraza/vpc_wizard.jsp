...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">VPC Set-up Wizard</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Tasks</a></li>
                    <li class="breadcrumb-item active">VPC Wizard</li>
                </ol>
            </div>
							...
							<div class="m-portlet__body m-portlet__body--no-padding">
								...
								<div class="m-wizard__form-step m-wizard__form-step--current" id="m_wizard_form_step_1">
									<div class="m-form__section m-form__section--first">
										...
										<label class="col-form-label">What is a Value Proposition Canvas?</label>
										<div class="form-group m-form__group m--margin-bottom-100">
										<p class="description">This is a Tool to Understand Your Product's Value from the Customer's Perspective.</p>
			                            <p class="description">A VPC has Two Parts.</p>
			                            <p class="description">The first part defines the Customer's profile/perspective. (Jobs, Pains and Gains)</p>
			                            <p class="description">On the second part, focus is made on features, functionality, and benefits your product can offer to not only attract customers but also meet their requirements.</p>
								...
								<div class="m-form__actions">
									<div class="row">
										...
										<div class="col-lg-6 m--align-center">
											<a href="#" class="btn btn-success m-btn m-btn--custom m-btn--icon saveVPC" data-wizard-action="submit">
											<span>
											<i class="la la-check"></i>&nbsp;&nbsp;
											<span>Save and Finish</span>
											</span>
											</a>
											<a href="#" class="btn btn-success m-btn m-btn--custom m-btn--icon updateVPC" data-wizard-action="next">
											<span>
											<span>Continue</span>&nbsp;&nbsp;
...
<script src="assets/canvas/js/vpc_wizard_api.js"></script>
<!--end::Page Scripts -->
