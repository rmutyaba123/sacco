...
public class BDateFormat {
	...
	public static String parseTime(String myTime, String timeType) {
		...
		try {
			...
			if(timeType.equals("1")) dateParse.applyPattern("hh:mm a");
			else if(timeType.equals("2")) dateParse.applyPattern("HH:mm");
			else if(timeType.equals("3")) dateParse.applyPattern("HH:mm");
